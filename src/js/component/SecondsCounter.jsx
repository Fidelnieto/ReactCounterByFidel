...
export function SecondCounter(props) {
  ...
  function updateCounter() {
    ...
    if (counter == props.seconds) {
      ...
      comment.innerHTML = "<strong>You reached the time</strong>"
  ...
  return (
    <div className='h-100 bg-dark d-flex text-light justify-content-center align-items-center' style={{ textAlign: 'center', fontSize: '24px' }}>
      <h1>
        <svg className='bg-light rounded-5 me-3' xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="50" height="50" viewBox="0 0 50 50">
